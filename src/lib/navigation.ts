...
export const navItemsByRole: Record<string, NavItem[]> = {
  admin_school: [
    ...
    { label: "Devoirs & TD", href: "/admin/devoirs", icon: "ClipboardCheck" },
  ...
  teacher: [
    ...
    { label: "Devoirs & TD", href: "/teacher/assignments", icon: "ClipboardCheck" },
  ...
  parent: [
    ...
    { label: "Devoirs & TD", href: "/parent/children", icon: "ClipboardCheck" },
  ...
  student: [
    ...
    { label: "Devoirs & TD", href: "/student/assignments", icon: "ClipboardCheck" },
